...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring("/store/mc/RunIIFall17MiniAODv2/TT_TuneCH3_13TeV-powheg-herwig7/MINIAODSIM/PU2017_12Apr2018_94X_mc2017_realistic_v14-v2/100000/26982FB2-66AE-E911-ABF3-0242AC130002.root"), #"file:data_miniAOD.root"
    duplicateCheckMode = cms.untracked.string("noDuplicateCheck"),
#    secondaryFileNames = cms.untracked.vstring("/store/data/Run2017F/SingleMuon/AOD/17Nov2017-v1/60006/F6F14634-3DE4-E711-8E23-24BE05C33C71.root") #"file:data_AOD.root"
)
...
if DATA and YEAR==2016:
	process.GlobalTag = GlobalTag(process.GlobalTag, '94X_dataRun2_v10') # data

if MC and YEAR==2017:
        process.GlobalTag = GlobalTag(process.GlobalTag, '94X_mc2017_realistic_v17', '') # MC

if DATA and YEAR==2017:
        process.GlobalTag = GlobalTag(process.GlobalTag, '106X_dataRun2_v11') # data 94X_dataRun2_v11
...
process.hltFilter.HLTPaths = ['HLT_Mu50_v*','HLT_Ele27_WPTight_Gsf_v*','HLT_IsoMu24_v*','HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_v*','HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_v*','HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass8_v*','HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass3p8_v*','HLT_IsoMu27_v*','HLT_IsoTkMu24_v*','HLT_Ele35_WPTight_Gsf_v*']
...
#    preselection = cms.string("electronID('cutBasedElectronID-Fall17-94X-V2-tight') && pt() > 50 && abs(eta()) < 2.4"),#    preselection = cms.string("electronID('cutBasedElectronID-Summer16-80X-V1-tight') && pt() > 50 && abs(eta()) < 2.4"), #electronID('egmGsfElectronIDs:cutBasedElectronID-Summer16-80X-V1-tight
...
if YEAR==2017:
	process.cleanPatElectrons.preselection = cms.string("electronID('cutBasedElectronID-Fall17-94X-V1-tight') && pt() > 50 && abs(eta()) < 2.4")
if YEAR==2016:
	process.cleanPatElectrons.preselection = cms.string("electronID('cutBasedElectronID-Summer16-80X-V1-tight') && pt() > 50 && abs(eta()) < 2.4")
...
if DATA and YEAR==2017:
        process.p = cms.Path(process.hltFilter*process.METFilter*process.ecalBadCalibReducedMINIAODFilter*process.cleanPatElectrons*process.cleanPatMuons*process.cleanJets*process.cleanJetsAK8*process.uncorrectedMet*process.Type1CorrForNewJEC*process.slimmedMETsNewJEC*process.filterJets*process.totemRPUVPatternFinder*process.totemRPLocalTrackFitter*process.ctppsPixelLocalTracks*process.ctppsLocalTrackLiteProducer*process.ctppsProtons*process.demo)
